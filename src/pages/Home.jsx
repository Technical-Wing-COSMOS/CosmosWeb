      ...
      <section className="min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              to="/join"
              className="px-8 py-3 rounded-full border border-gray-600 hover:border-orange-500 transition"
            >
              Join Us
            </Link>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            {[
              ...
              <Link
                key={item.title}
                to={item.link}
                className="block p-8 rounded-2xl bg-zinc-900 border border-zinc-800 hover:border-orange-500 transition"
              >
